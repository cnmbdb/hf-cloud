...
<head>
    ...
    <script src="{$Request.domain}/themes/clientarea/default/v10/view/noVNC/vendor/promise.js"></script>
    <script src="{$Request.domain}/themes/clientarea/default/v10/view/noVNC/utils/jquery.min.js"></script>
    ...
    <script>
        window.addEventListener("load", function() {
            ...
            loader.src = "{$Request.domain}/themes/clientarea/default/v10/view/noVNC/vendor/browser-es-module-loader/dist/" +
    ...
    <script type="module" crossorigin="anonymous">
        ...
        import RFB from '{$Request.domain}/themes/clientarea/default/v10/view/noVNC/core/rfb.js';
