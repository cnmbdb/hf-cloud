...
<link href="/themes/clientarea/ogmiao/assets/css/bootstrap.min.css?v={$Ver}" rel="stylesheet" type="text/css" />
<link href="/themes/clientarea/ogmiao/assets/css/icons.min.css?v={$Ver}" rel="stylesheet" type="text/css" />
<link href="/themes/clientarea/ogmiao/assets/css/app.min.css?v={$Ver}" rel="stylesheet" type="text/css" />
...
<link href="/themes/clientarea/ogmiao/assets_custom/css/shadcn-nav.css?v={$Ver}-20260629a" rel="stylesheet">
...
<!-- 字体图标 -->
 ...
 <link href="/themes/clientarea/ogmiao/assets_custom/fonts/iconfont.css?v={$Ver}" rel="stylesheet"> 

<!-- JAVASCRIPT -->
<script src="/themes/clientarea/ogmiao/assets/libs/jquery/jquery.min.js?v={$Ver}"></script>
<script src="/themes/clientarea/ogmiao/assets/libs/bootstrap/js/bootstrap.bundle.min.js?v={$Ver}"></script>
<script src="/themes/clientarea/ogmiao/assets/libs/metismenu/metisMenu.min.js?v={$Ver}"></script>
<script src="/themes/clientarea/ogmiao/assets/libs/simplebar/simplebar.min.js?v={$Ver}"></script>
<script src="/themes/clientarea/ogmiao/assets/libs/node-waves/waves.min.js?v={$Ver}"></script>
