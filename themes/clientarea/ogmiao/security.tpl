...
/* shadcn dark security page overrides */
:root {
  --primary: #fafafa;
  --primary-dark: #e5e5e5;
...
html, body, .main-content, .page-content, .container-fluid {
...
.card:hover, .security-item:hover { transform: none !important; box-shadow: none !important; }

.card-body { padding: 24px; }

.decoration, .security-header::before, .security-header::after, .btn-primary::after { display: none !important; }

.security-header { background: #09090b !important; border: 1px solid #27272a !important; }

.security-avatar { justify-content: center; }
...
.security-info { padding: 0; }

.security-username { color: #fafafa; font-size: 24px; line-height: 1.2; }

.security-label, .security-meta, .security-meta label, .security-item-desc {
  color: #a1a1aa !important;
}

.security-meta ul { display: flex; flex-wrap: wrap; gap: 10px 18px; }
.security-meta .list-inline-item { margin-right: 0; }

.progress { height: 8px; background: #18181b !important; border: 1px solid #27272a; }
.progress-bar { background: #fafafa !important; }

.security-items { gap: 12px; }
...
.security-item-icon, .bg-primary, .bg-info {
  background: #18181b !important;
  border: 1px solid #27272a;
...
.security-item-info { gap: 16px; }

.security-item-title, .card-title, .modal-title, .col-form-label { color: #fafafa; }

.security-item-title small { color: #22c55e; }

.badge { border-radius: 9999px; border: 1px solid #27272a; box-shadow: none !important; }
.badge-success { background: rgba(34, 197, 94, 0.12); color: #86efac; }
.badge-light, .novalid { background: #18181b !important; color: #a1a1aa !important; border-color: #27272a; box-shadow: none; }

.btn, .btn-primary, .btn-outline-primary, .btn-outline-light, .btn-secondary, .btn-default {
  border-radius: 6px !important; font-weight: 500;
  padding: 0.55rem 0.9rem;
  transition: background-color 0.15s ease, border-color 0.15s ease, color 0.15s ease;
}

.btn-primary { background: #fafafa !important; border-color: #fafafa !important; color: #09090b !important; }
.btn-primary:hover { background: #e5e5e5 !important; border-color: #e5e5e5 !important; color: #09090b !important; }

.btn-outline-primary, .btn-outline-light, .btn-secondary, .btn-default {
  background: #09090b !important; border: 1px solid #27272a !important; color: #fafafa !important;
}

.btn-outline-primary:hover, .btn-outline-light:hover, .btn-secondary:hover, .btn-default:hover {
  background: #18181b !important; border-color: #3f3f46 !important; color: #fafafa !important;
}

.btn:disabled, .btn[disabled] {
  background: #18181b !important; border-color: #27272a !important; color: #71717a !important; cursor: not-allowed;
}

.form-control, .custom-select {
  background: #000 !important; border: 1px solid #27272a !important;
  border-radius: 6px !important; box-shadow: none !important;
  color: #fafafa !important; height: calc(1.5em + 1rem + 2px);
}

.form-control:focus { border-color: #fafafa !important; box-shadow: 0 0 0 2px rgba(250, 250, 250, 0.16) !important; }
.form-control::placeholder { color: #71717a; }
.form-control[readonly] { background: #18181b !important; color: #a1a1aa !important; }

.input-group-append .btn { border-top-left-radius: 0 !important; border-bottom-left-radius: 0 !important; }

.modal-header, .modal-footer { background: #09090b !important; border-color: #27272a !important; }
.modal-header .close, .modal-header .close span { color: #fafafa; text-shadow: none; }
.modal-body { background: #09090b; color: #fafafa; }
...
@media (max-width: 768px) {
  ...
  .main-content, .page-content, .container-fluid { width: 100% !important; max-width: 100% !important; }
  .page-content { padding: 16px 0 78px !important; }
  .container-fluid { padding-left: 12px !important; padding-right: 12px !important; }

  .row > [class*="col-"], .row > .col-sm-2, .row > .col-sm-3, .row > .col-sm-4,
  .row > .col-sm-5, .row > .col-sm-8, .row > .col-sm-9, .row > .col-md-1 {
    flex: 0 0 100% !important; max-width: 100% !important; width: 100% !important;
    padding-left: 6px !important; padding-right: 6px !important;
  }

  .card-body { padding: 18px !important; }
  .security-header .row { gap: 14px; }
  .security-header .ml-3 { margin-left: 0 !important; }
  .security-header { margin-bottom: 12px !important; }
  .security-avatar { justify-content: flex-start; }

  .security-username { align-items: flex-start; flex-direction: column; font-size: 20px; gap: 8px; overflow-wrap: anywhere; }
  .security-meta { font-size: 13px; }
  .security-meta ul, .security-meta ul ul { display: grid; gap: 8px; padding-left: 0; width: 100%; }
  .security-meta .list-inline-item { display: block; max-width: 100%; overflow-wrap: anywhere; }

  .security-item { align-items: stretch; gap: 12px; padding: 14px; }
  .security-item-icon { flex: 0 0 42px; height: 42px; width: 42px; }
  .security-item-info { align-items: stretch; flex-direction: column; width: 100%; }
  .security-item-title { align-items: flex-start; flex-direction: column; font-size: 16px; gap: 6px; line-height: 1.35; }
  .security-item-title small, .security-item-title .phonehide, .security-item-desc {
    max-width: 100%; overflow-wrap: anywhere; white-space: normal !important;
  }
  .security-item-desc { font-size: 13px; line-height: 1.55; }
  .security-item .btn, .security-item button { width: 100%; }

  .modal-dialog { margin: 10px; max-width: calc(100% - 20px); }
  .modal-body, .modal-header, .modal-footer { padding: 16px !important; }
  .modal-body .form-group.row { display: block; margin-left: 0 !important; margin-right: 0 !important; }
  .modal-body .col-form-label { display: block; padding: 0 0 8px !important; text-align: left !important; width: 100%; }
  .modal-body .form-group [class*="col-sm-"] { max-width: 100% !important; padding-left: 0 !important; padding-right: 0 !important; width: 100% !important; }
  .modal-footer { display: grid; gap: 8px; }
  .modal-footer .btn { margin: 0 !important; width: 100%; }
  .input-group { flex-wrap: nowrap; width: 100%; }
  .input-group .form-control { min-width: 0; }
  .input-group-append .btn { padding-left: 0.7rem; padding-right: 0.7rem; white-space: nowrap; }
}

@media (max-width: 420px) {
  .security-item { flex-direction: column; }
  .security-logo { height: 52px; width: 52px; }
  .security-username { font-size: 18px; }
  .btn, .btn-primary, .btn-outline-primary, .btn-outline-light, .btn-secondary, .btn-default {
    min-height: 40px; padding-left: 0.75rem; padding-right: 0.75rem;
  }
}
