							...
							<tr>
								...
								<td>
									<a href=" servicedetail?id={$list.id}" class="text-dark">
										<strong>{if $list.notes}{$list.notes}{else}我的虚拟主机{/if}</strong>
								...
								<td>
								    {if $list.site_max}<span><i class="bx bx-save"></i> 空间：{$list.site_max}</span><br>{/if}
                                    {if $list.space}<span><i class="bx bx-save"></i> 空间：{$list.space}</span><br>{/if}
                                    {if $list.web_quota}<span><i class="bx bx-save"></i> 空间：{$list.web_quota}</span><br>{/if}
                                    {if $list.webdx}<span><i class="bx bx-save"></i> 空间：{$list.webdx}</span><br>{/if}
                                    {if $list.sql_max}<span><i class="bx bx-data"></i> 数据库：{$list.sql_max}</span><br>{/if}
                                    {if $list.db_quota}<span><i class="bx bx-data"></i> 数据库：{$list.db_quota}</span><br>{/if}
                                    {if $list.db}<span><i class="bx bx-data"></i> 数据库：{$list.db}</span><br>{/if}
                                    {if $list.sqldx}<span><i class="bx bx-data"></i> 数据库：{$list.sqldx}</span><br>{/if}
                                    {if $list.flow_max}<span><i class="bx bx-cloud-rain"></i> 月流量：{$list.flow_max}</span><br>{/if}
                                    {if $list.flow_limit}<span><i class="bx bx-cloud-rain"></i> 月流量：{$list.flow_limit}</span><br>{/if}
                                    {if $list.bandwidth}<span><i class="bx bx-cloud-rain"></i> 月流量：{$list.bandwidth}</span><br>{/if}
                                    {if $list.broadband_up}<span><i class="bx bx-up-arrow-alt"></i> {$list.broadband_up} / <i class="bx bx-down-arrow-alt"></i> {$list.broadband_down}</span><br>{/if}
                                    {if $list.speed}<span><i class="bx bx-up-arrow-alt"></i> {$list.speed} / <i class="bx bx-down-arrow-alt"></i> {$list.speed}</span><br>{/if}
								</td>
								<td>
