<?php /*a:6:{s:66:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/news.tpl";i:1743848185;s:75:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/head.tpl";i:1742354372;s:75:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/menu.tpl";i:1720065013;s:81:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/pageheader.tpl";i:1719999923;s:81:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/breadcrumb.tpl";i:1719999923;s:82:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/tablefooter.tpl";i:1719999923;}*/ ?>
  ...
  <div class="col-xl-9 col-lg-8">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="section-title"><?php echo $Lang['announcement']; ?></h4>
        
        <div class="news-list">
          <?php if($NewsList): foreach($NewsList as $news): ?>
              <a href="./newsview?id=<?php echo $news['id']; ?>" class="news-item">
                <div class="news-content">
                  <i class="bx bx-news news-icon"></i>
                  <h5 class="news-title"><?php echo $news['title']; ?></h5>
                </div>
                <div class="news-date"><?php echo date('Y-m-d H:i',!is_numeric($news['push_time'])? strtotime($news['push_time']) : $news['push_time']); ?></div>
              </a>
            <?php endforeach; else: ?>
            <div class="text-center py-5">
              <i class="bx bx-news" style="font-size: 48px; color: var(--primary); opacity: 0.5;"></i>
              <p class="mt-3 text-muted"><?php echo $Lang['nothing']; ?></p>
            </div>
          <?php endif; ?>
        </div>
...
<script>
	$(function () {
		...
		$('#limitSel').on('change', function () {
			if ('<?php echo app('request')->get('action'); ?>') {
				location.href = 'news?action=<?php echo app('request')->get('action'); ?>&keywords=<?php echo app('request')->get('keywords'); ?>&sort=<?php echo app('request')->get('sort'); ?>&orderby=<?php echo app('request')->get('orderby'); ?>&page=1&limit=' + $('#limitSel').val()
			} else {
				location.href = 'news?keywords=<?php echo app('request')->get('keywords'); ?>&sort=<?php echo app('request')->get('sort'); ?>&orderby=<?php echo app('request')->get('orderby'); ?>&page=1&limit=' + $('#limitSel').val()
			}
  ...
  <div class="col-xl-3 col-lg-4">
    <div class="card">
      <div class="card-body">
        <h4 class="section-title"><?php echo $Lang['search']; ?></h4>
        <div class="search-box">
          <input type="text" class="search-input" id="searchInp" placeholder="<?php echo $Lang['search_by_keyword']; ?>">
          <i class="bx bx-search-alt search-icon"></i>
        </div>

        <h4 class="section-title mt-4"><?php echo $Lang['classification']; ?></h4>
        <ul class="category-list">
          <?php foreach($NewsCate as $classify): ?>
            <li class="category-item">
              <a href="./news?cate=<?php echo $classify['id']; ?>" class="category-link">
                <div class="category-name">
                  <i class="bx bx-folder category-icon"></i>
                  <span><?php echo $classify['title']; ?></span>
                </div>
                <span class="category-badge"><?php echo $classify['count']; ?></span>
              </a>
            </li>
          <?php endforeach; ?>
        </ul>
