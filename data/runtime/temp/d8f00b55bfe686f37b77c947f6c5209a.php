<?php /*a:3:{s:65:"/www/wwwroot/cloud.hf.pw2/public/themes/web/zjmf/helparticle.html";i:1758904948;s:67:"/www/wwwroot/cloud.hf.pw2/public/themes/web/zjmf/common/header.html";i:1758904948;s:67:"/www/wwwroot/cloud.hf.pw2/public/themes/web/zjmf/common/footer.html";i:1758904948;}*/ ?>
...
<head>
  <meta charset="utf-8" />
  <title>客服 - <?php echo $setting['company_name']; ?></title>
...
word-wrap: break-word;
  ...
  <section class="page-hero tos space2x">
			    	<div class="container page-hero-text">
			    		<div class="row">
			    			<div class="col-sm-6">
			    				<h2><?php echo $helpContent['title']; ?></h2>
			    				<p class="hero-slogan">发布时间:<?php echo date('Y-m-d H:i',!is_numeric($helpContent['push_time'])? strtotime($helpContent['push_time']) : $helpContent['push_time']); ?></p>
			    			</div>
			    		</div>
			    	</div>
  </section>
			...
			<div class="col-md-9">
			    ...
			    <div class="article-content bg-white">
		            <ol class="breadcrumb entry-breadcrumb">
			            			            <li><i class="fas fa-map-marker-alt mr-1"></i> <a href="<?php echo $setting['web_url']; ?>">首页</a></li>
			            			            <li><a href="#"><?php echo $helpContent['cate_name']; ?></a></li>
			            			        </ol>
		            <div class="article-body">
			            <article class="entry py-3">
				        	<div class="entry-head">
		                        <h1 class="entry-title"><?php echo $helpContent['title']; ?></h1>
		                        <div class="entry-info">
		                            <span><?php echo date('Y-m-d H:i',!is_numeric($helpContent['push_time'])? strtotime($helpContent['push_time']) : $helpContent['push_time']); ?></span>
		                           
		                        </div>
		                    </div>
		                    <div class="entry-content">
			                <?php echo $helpContent['content']; ?>
		                    </div>
