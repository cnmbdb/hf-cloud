                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-8">
                            <div>
                                <div class="text-center">
                                    <div class="mb-4">
                                        <span class="badge badge-light font-size-12">
                                            <i
                                                class="bx bx-purchase-tag-alt align-middle text-muted mr-1"></i><?php echo $KnowledgeBaseArticle['cate_name']; ?>
                                        </span>
                                    </div>
                                    <h4><?php echo $KnowledgeBaseArticle['title']; ?></h4>
                                    <p class="text-muted mb-4"><i class="mdi mdi-calendar mr-1"></i>
                                        <?php echo date('Y-m-d H:i',!is_numeric($KnowledgeBaseArticle['create_time'])? strtotime($KnowledgeBaseArticle['create_time']) : $KnowledgeBaseArticle['create_time']); ?></p>
                                </div>
                                <hr>
                                <div class="mt-4">
                                    <div class="text-muted font-size-14">
                                        <p><?php echo $KnowledgeBaseArticle['description']; ?></p>
                                ...
                                <div class="mt-4">
                                    <h5 class="mb-3"><?php echo $Lang['label']; ?>: </h5>
                                ...
                                <div class="mt-4 d-flex justify-content-between">
                                    ...
                                    <a href="knowledgebaseview?id=<?php echo $KnowledgeBaseArticle['prev']['id']; ?>"
                                        class="btn btn-primary"><i
                                            class="bx bx-left-arrow-alt font-size-16 align-middle mr-2"></i> <?php echo $KnowledgeBaseArticle['prev']['title']; ?></a>
                                    <?php endif; if($KnowledgeBaseArticle['next']): ?>
                                    <a href="knowledgebaseview?id=<?php echo $KnowledgeBaseArticle['next']['id']; ?>"
                                        class="btn btn-primary"> <?php echo $KnowledgeBaseArticle['next']['title']; ?><i
...
<!-- end row --><?php if($TplName != 'login' && $TplName != 'register' && $TplName != 'pwreset' && $TplName != 'bind' && $TplName != 'loginaccesstoken'): ?>
</div>
</div>
</div>
