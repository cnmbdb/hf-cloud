        ...
        <div class="col-xl-12">
          <div class="mt-5">
            ...
            <div class="list-group list-group-flush">
              ...
              <a href="./newsview?id=<?php echo $news['id']; ?>" class="list-group-item text-muted d-flex justify-content-between">
                <div>
                  <i class="mdi mdi-circle-medium mr-1"></i> <?php echo $news['title']; ?>
                </div>
                <div>
                  <span><?php echo date('Y-m-d H:i',!is_numeric($news['push_time'])? strtotime($news['push_time']) : $news['push_time']); ?></span>
                </div>
              </a>
              <?php endforeach; ?>
            </div>
      ...
      <div class="card-body p-4">
        ...
        <div>
          ...
          <ul class="list-unstyled font-weight-medium">
            ...
            <li><a href="./news?cate=<?php echo $classify['id']; ?>" class="text-muted py-2 d-block"><i
