      ...
      <div class="d-flex flex-column h-100">
        <div class="mb-4">
          <ul class="list-unstyled categories-list">
            ...
            <li>
              <a href="./downloads?cate_id=<?php echo $cate_data['id']; ?>" class="text-body d-flex align-items-center">
      ...
      <div class="card-body">
        ...
        <div class="mt-4">
          <div class="d-flex flex-wrap">
            <h5 class="font-size-14 mr-3"><?php echo $Lang['downloads_directory']; ?></h5>
          ...
          <div class="table-responsive">
            <table class="table table-centered table-nowrap table-hover mb-0">
              ...
              <tbody>
                ...
                <?php foreach($Downloads['downloads']['downloads'] as $downloads): ?>
                <tr>
                  <td>
                    <a href="<?php echo $downloads['down_link']; ?>" class="text-dark font-weight-medium">
                      <i
                        class="<?php if($downloads['type'] == '1'): ?>mdi mdi-folder-zip text-warning<?php elseif($downloads['type'] == '2'): ?>mdi mdi-image text-success<?php elseif($downloads['type'] == '3'): ?>mdi mdi-text-box text-muted<?php endif; ?> font-size-16 mr-2"></i>
                      <?php echo $downloads['title']; ?></a>
                  </td>
                  <td><?php echo date('Y-m-d H:i',!is_numeric($downloads['update_time'])? strtotime($downloads['update_time']) : $downloads['update_time']); ?></td>
                  <td><?php echo $downloads['downloads']; ?></td>
                  <td>
                    <div class="dropdown">
                      <a href="<?php echo $downloads['down_link']; ?>" class="font-size-16 text-primary">
