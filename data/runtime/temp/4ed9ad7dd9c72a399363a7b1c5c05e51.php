...
<div class="container-fluid p-0">
  ...
  <div class="row no-gutters">
    ...
    <!--  20241015 新增模板钩子 -->
    <?php $hooks=hook('template_custom_clientarea_captcha_html',['id'=>'allow_email_forgetpwd_captcha']); if(!empty($hooks[0])): foreach($hooks as $item): ?>
        <?php echo $item; ?>
      <?php endforeach; else: ?>
...
<?php endif; ?>
    ...
    <!--  20241015 新增模板钩子 -->
    <?php $hooks=hook('template_custom_clientarea_captcha_html',['id'=>'allow_phone_forgetpwd_captcha']); if(!empty($hooks[0])): foreach($hooks as $item): ?>
        <?php echo $item; ?>
      <?php endforeach; else: ?>
