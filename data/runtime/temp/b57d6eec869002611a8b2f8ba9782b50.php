<?php /*a:7:{s:76:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/default/knowledgebase.tpl";i:1758904948;s:76:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/default/includes/head.tpl";i:1758904948;s:76:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/default/includes/menu.tpl";i:1758904948;s:82:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/default/includes/pageheader.tpl";i:1758904948;s:82:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/default/includes/breadcrumb.tpl";i:1758904948;s:83:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/default/includes/tablefooter.tpl";i:1758904948;s:83:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/default/includes/tablesearch.tpl";i:1758904948;}*/ ?>
        ...
        <div class="col-xl-12">
          <div class="mt-5">
            ...
            <div class="list-group list-group-flush">
              ...
              <a href="./knowledgebaseview?id=<?php echo $help['id']; ?>"
                class="list-group-item text-muted d-flex justify-content-between">
                <div>
                  <i class="mdi mdi-circle-medium mr-1"></i> <?php echo $help['title']; ?>
                </div>
                <div style="width: 110px;">
                  <span><?php echo date('Y-m-d H:i',!is_numeric($help['create_time'])? strtotime($help['create_time']) : $help['create_time']); ?></span>
                </div>
              </a>
              <?php endforeach; ?>
            </div>
...
<script>
	$(function () {
		...
		$('#limitSel').on('change', function () {
			if ('<?php echo app('request')->get('action'); ?>') {
				location.href = 'knowledgebase?action=<?php echo app('request')->get('action'); ?>&keywords=<?php echo app('request')->get('keywords'); ?>&sort=<?php echo app('request')->get('sort'); ?>&orderby=<?php echo app('request')->get('orderby'); ?>&page=1&limit=' + $('#limitSel').val()
			} else {
				location.href = 'knowledgebase?keywords=<?php echo app('request')->get('keywords'); ?>&sort=<?php echo app('request')->get('sort'); ?>&orderby=<?php echo app('request')->get('orderby'); ?>&page=1&limit=' + $('#limitSel').val()
			}
    ...
    <div class="card">
      <div class="card-body p-4">
        <div class="search-box">
          <p class="text-muted"><?php echo $Lang['search']; ?></p>
  ...
  $(function () {
    ...
    $('#searchInp').on('keydown', function (e) {
      if (e.keyCode == 13) {
        location.href = 'knowledgebase?keywords=' + $('#searchInp').val() + '&sort=<?php echo app('request')->get('sort'); ?>&orderby=<?php echo app('request')->get('orderby'); ?>&page=<?php echo app('request')->get('page'); ?>&limit=<?php echo app('request')->get('limit'); ?>'
      }
    })
    ...
    $('.bg-light th').on('click', function () {
      var sort = '<?php echo app('request')->get('sort'); ?>'
      location.href = 'knowledgebase?keywords=<?php echo app('request')->get('keywords'); ?>&sort=' + (sort == 'desc' ? 'asc' : 'desc') + '&orderby=' + $(this).attr('prop') + '&page=<?php echo app('request')->get('page'); ?>&limit=<?php echo app('request')->get('limit'); ?>'
    })
  })
</script>
  ...
  <div class="col-sm-6">
    <div class="search-box">
      <div class="position-relative">
        ...
        <hr class="my-4">
        <div>
          <p class="text-muted"><?php echo $Lang['classification']; ?></p>
          <ul class="list-unstyled font-weight-medium">
            <?php foreach($HelpCate as $classify): ?>
            <li><a href="./knowledgebase?cate=<?php echo $classify['id']; ?>" class="text-muted py-2 d-block"><i
                  class="mdi mdi-chevron-right mr-1"></i> <?php echo $classify['title']; ?> <span
                  class="badge badge-soft-success badge-pill float-right ml-1 font-size-12"><?php echo $classify['count']; ?>
                </span></a></li>
            <?php endforeach; ?>
          </ul>
        </div>
