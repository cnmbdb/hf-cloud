<?php /*a:6:{s:75:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/knowledgebase.tpl";i:1743846930;s:75:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/head.tpl";i:1742354372;s:75:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/menu.tpl";i:1720065013;s:81:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/pageheader.tpl";i:1719999923;s:81:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/breadcrumb.tpl";i:1719999923;s:82:"/www/wwwroot/cloud.hf.pw2/public/themes/clientarea/ogmiao/includes/tablefooter.tpl";i:1719999923;}*/ ?>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="knowledge-list">
          <?php if($HelpList): foreach($HelpList as $help): ?>
              <a href="./knowledgebaseview?id=<?php echo $help['id']; ?>" class="knowledge-item">
                <i class="bx bx-file knowledge-icon"></i>
                <div class="knowledge-content">
                  <h5 class="knowledge-title"><?php echo $help['title']; ?></h5>
                </div>
                <div class="knowledge-date"><?php echo date('Y-m-d',!is_numeric($help['create_time'])? strtotime($help['create_time']) : $help['create_time']); ?></div>
              </a>
            <?php endforeach; else: ?>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="knowledge-search">
          <input type="text" class="knowledge-search-input" id="searchInp" placeholder="<?php echo $Lang['search_by_keyword']; ?>">
        ...
        <ul class="category-list">
          <?php foreach($HelpCate as $classify): ?>
            <li class="category-item">
              <a href="./knowledgebase?cate=<?php echo $classify['id']; ?>" class="category-link">
